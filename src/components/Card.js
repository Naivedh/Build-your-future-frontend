...
const renderCourseNames = (courses) => {
  const min = Math.min(courses.length, 2);
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="form-group">
                <label htmlFor="course_name" className="card__text">
                  Course Name
                </label>
                <input
              ...
              <div className="form-group">
                <label htmlFor="descripton" className="card__text">
                  Descripton
                </label>
                <textarea
                  className="form-control"
              ...
              <div className="form-group">
                <label htmlFor="photo" className="card__text">
                  Picture
                </label>
                <input
                  className="form-control"
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                onClick={
                  submitEditedData && submitEditedData(currentCourseData)
                }
              >
