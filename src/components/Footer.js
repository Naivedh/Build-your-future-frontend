    ...
    return (
        ...
        <section className="">
            ...
            <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <p>
                <Link to="/appointments"className="text-white">Appointment</Link>
                </p>
                <p>
                <Link to="/" className="text-white">Tutors</Link>
                </p>
        ...
        <div
            ...
            >
        © 2022 Copyright:
        <Link className="text-white" to="/">buildyourfuture.com</Link>
        </div>
    </footer> 
    );
}
